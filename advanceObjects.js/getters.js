...
// But they can do more than just retrieve the value of a property! Let’s take
// a look at a getter method:
const person = {
  _firstName: 'John',
  _lastName: 'Doe',
  get fullName() {
...
// (by making sure they both return truthy values) and then return a different value
...
// properties cannot share the same name as the getter/setter function. If we
// do so, then calling the method will result in an infinite call stack error.
// One workaround is to add an underscore before the property name like we did
